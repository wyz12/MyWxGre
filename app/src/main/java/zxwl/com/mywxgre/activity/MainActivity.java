...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        sserviceName = getPackageName() + "/.service.WxEnvelopeService";
        //财神的动画
        ...
        if (isRedEnvelopeEnable() && isSServiceRunning()) {
    ...
    public boolean isSServiceRunning() {
        return BaseAccessibilityService.getInstance().checkAccessibilityEnabled(sserviceName);
    }
    ...
    protected void onRestart() {
        ...
        if (isJumpSetting == true&&isSServiceRunning()) {
